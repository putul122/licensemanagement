...
const SET_RELATIONSHIP_ACTION_SETTINGS = 'AgreementsReducer/SET_RELATIONSHIPS_ACTION_SETTINGS'
const RESET_RESPONSE = 'AgreementsReducer/RESET_RESPONSE'
const SET_EDIT_COMPONENT_FLAG = 'AgreementsReducer/SET_EDIT_COMPONENT_FLAG'
const PUSH_COMPONENT_PROPERTY_PAYLOAD = 'AgreementsReducer/PUSH_COMPONENT_PROPERTY_PAYLOAD'
const EDIT_COMPONENT_PROPERTIES = 'AgreementsReducer/EDIT_COMPONENT_PROPERTIES'
const COPY_AGREEMENT_PROPERTIES = 'AgreementsReducer/COPY_AGREEMENT_PROPERTIES'
const COPY_AGREEMENT_DATA = 'AgreementsReducer/COPY_AGREEMENT_DATA'
const RESTORE_AGREEMENT_PROPERTIES = 'AgreementsReducer/RESTORE_AGREEMENT_PROPERTIES'
const EDIT_COMPONENT_RELATIONSHIP_PROPERTY = 'AgreementsReducer/EDIT_COMPONENT_RELATIONSHIP_PROPERTY'
const RESET_COMPONENT_RELATIONSHIP_PROPERTY = 'AgreementsReducer/RESET_COMPONENT_RELATIONSHIP_PROPERTY'
...
export const initialState = {
  ...
  agreementPropertiesPayload: {property: [], component: [], relationship: []},
