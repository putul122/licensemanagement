    ...
    <div id='m_aside_left' className='m-grid__item	m-aside-left  m-aside-left--skin-light '>
      ...
      <div id='m_ver_menu' className='m-aside-menu  m-aside-menu--skin-light m-aside-menu--submenu-skin-light '>
        <ul className='m-menu__nav  m-menu__nav--dropdown-submenu-arrow '>
          ...
          <div style={{'padding': '15px'}}><li className='m-menu__item--submenu m-menu__item--submenu-fullheight' style={{'textAlign': 'center'}} ><a href='javascript:;' className='m-menu__link'><i className='m-menu__link-icon fa fa-snowflake-o' style={{'fontSize': '35px'}} /></a></li><div className={styles.sidebarlink}><a href='/softwares'>Softwares</a></div></div>
          <div style={{'padding': '15px'}}><li className='m-menu__item--submenu m-menu__item--submenu-fullheight' style={{'textAlign': 'center'}} ><a href='javascript:;' className='m-menu__link'><i className='m-menu__link-icon  fa fa-tasks' style={{'fontSize': '35px'}} /></a></li><div className={styles.sidebarlink}><a href='/applications'>Applications</a></div></div>
        </ul>
      </div>
    </div>
  </div>
