...
import styles from './applicationviewComponent.scss'

export default function Applicationview (props) {
  console.log('Single Application Data', OneApplication)
    return (
      <div>
        <h2>CPH Clarify 10: Customer Problem Handler</h2>
        <div className='row'>
                ...
                <div className='m-widget12'>
                  <div className='m-widget12__item'>
                    <span className='m-widget12__text1'>
                      <h1>Total Cost</h1>
                      <br />
                      <h2 className='pull-right'> R 123.456</h2>
                    </span>
                  </div>
                </div>
              </div>
